...
.then(() => {
 ...
 <div className=' bg-white w-full shadow-custom  sticky top-0 z-50'  data-aos-duration="500"  data-aos="fade-down">
...
<Link to="/About"className={`font-semibold text-lg transition-colors duration-300 hover:text-[rgb(184,142,47)]	 ${isActive('/About')}`}>
About Us  
</Link>  
</div>
 </div>
